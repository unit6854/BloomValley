    ...
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '64px 32px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', marginBottom: '64px' }}>
          ...
          <section>
            <h2 style={{ fontFamily: 'Arial', fontWeight: 'bold', fontSize: '25px', color: '#790D1D', marginBottom: '24px' }}>Customer Spotlight</h2>
            {testimonials.map((t, i) => (
              <div key={i} style={{ border: '2px solid #79512E', padding: '24px', marginBottom: '16px', backgroundColor: '#E0D2BD' }}>
        ...
        <section>
          <h2 style={{ fontFamily: 'Arial', fontWeight: 'bold', fontSize: '25px', color: '#790D1D', marginBottom: '24px' }}>Community Involvement</h2>
